...
def get_recommendations(genre):
    ...
    top_3_most_similar = pd.DataFrame(top_3_most_similar, columns = ['Title', 'Genres', 'Release Year'])
...
st.markdown("<h5 style='text-align: center; color: #10316B;'>Please select your mood below for us to make recommendations.</h5>", unsafe_allow_html=True)
