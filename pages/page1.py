...
st.markdown("<h4 style='color: #10316B;'>This is where you get movies which is content-related to your reference. Enter your favorite movie\'s name and let the system do the rest!</h4>", unsafe_allow_html=True)
